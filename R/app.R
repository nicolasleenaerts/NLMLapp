      ...
      tabPanel("Results",
               tabsetPanel(
                 ...
                 tabPanelBody("results_family_pooled",
                              ...
                              dataTableOutput("results_table_pooled_average"),style = "height:800px; overflow-y: scroll;overflow-x: scroll;",
                              dataTableOutput("results_table_pooled_metrics"),style = "height:800px; overflow-y: scroll;overflow-x: scroll;",
                              dataTableOutput("results_table_pooled_estimates"),style = "height:800px; overflow-y: scroll;overflow-x: scroll;"
                 ),
                 tabPanelBody("results_family_person",
                              HTML('Download results <br/>'),
                              downloadButton("download_person"),
                              dataTableOutput("results_table_person_average"),style = "height:800px; overflow-y: scroll;overflow-x: scroll;",
  ...
  server <- function(input, output, session) {
    ...
    observeEvent(input$model_type, {
      ...
      if (input$model_type==T){
        ...
        output$results_table_pooled_estimates <- renderDataTable({
      ...
      # Results for person-specific model
        ...
        output$results_table_person_average <- renderDataTable({
        ...
        output$results_table_person <- renderDataTable({
